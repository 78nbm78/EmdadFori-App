...
const ApplicantLoginForm = () => {
  ...
  const onShowSignupForm = () => {
    setApplicantLoginForm(false);
    setApplicantSignupForm(true);
  };
  ...
  const onSubmit: SubmitHandler<ILoginInputs> = async (data) => {
    try {
      const response: ILoginResponse | undefined = await ApplicantLoginAPI({
        mobile: data.mobile,
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          کاربر گرامی خوش آمدید! برای دسترسی به امکانات لطفا وارد سامانه شوید.
        </CardDescription>
      </CardHeader>
...
export default React.memo(ApplicantLoginForm);
