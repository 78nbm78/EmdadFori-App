...
const HomeIntro = () => {
  return (
    <section className="container-fluid !px-0">
        ...
        <SwiperSlide>
          <figure className="relative">
            <Image
              ...
              src={Slide1}
              className="block w-full object-cover object-center max-h-[360px] sm:max-h-[480px] lg:max-h-[600px]"
            />
      ...
      <div className="flex">
        <div className="flex-1 border-b-2 border-transparent xs:text-base bg-green-500 p-5 sm:p-6 text-center flex items-center gap-2 justify-center">
        ...
        <div className="flex-1 border-b-2 border-green-500 bg-white text-green-600 p-5 sm:p-6 flex items-center justify-center">
          <a
            href="tel:+98"
